...
func (SegmentStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_segment_a22460cc44f9de51, []int{0}
}
...
func init() {
	proto.RegisterFile("github.com/aperturerobotics/inca/segment/segment.proto", fileDescriptor_segment_a22460cc44f9de51)
}

var fileDescriptor_segment_a22460cc44f9de51 = []byte{
